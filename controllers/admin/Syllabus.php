        ...
        foreach ($days as $day_key => $day_value) {
            ...
            if (isset($role_id) && ($userdata["role_id"] == 2) && ($userdata["class_teacher"] == "yes")) {
                ...
                if (!empty($myclasssubjects[0]->timetable_id)) {
                    ...
                    $timetableid = substr_replace($myclasssubjects[0]->timetable_id,"",-1);
                    $concate     = "yes";
                }
            ...
            if ($timetableid == '') {
                ...
                $timetableid = substr_replace(implode(',',array_unique(explode(',', $timetableid))),"", -1);
